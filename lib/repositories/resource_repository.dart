...
class ResourceRepository {
  ...
  Future<List<Penjual>> getPenjuals() async {
    try {
      ...
      _syncService.cacheData('penjual', data);
  ...
  Future<void> storePenjual(Map<String, dynamic> data) async {
    try {
      final connectivity = await Connectivity().checkConnectivity();
      if (connectivity.contains(ConnectivityResult.none)) {
        await _syncService.addToQueue(ApiConstants.penjual, 'POST', data);
        return;
      }
  ...
  Future<void> updatePenjual(int id, Map<String, dynamic> data) async {
    try {
      ...
      if (connectivity.contains(ConnectivityResult.none)) {
        await _syncService.addToQueue(url, 'PUT', data);
        return;
      }
  ...
  Future<List<Supir>> getSupirs() async {
    try {
      ...
      _syncService.cacheData('supir', data);
  ...
  Future<void> storeSupir(Map<String, dynamic> data) async {
    try {
      final connectivity = await Connectivity().checkConnectivity();
      if (connectivity.contains(ConnectivityResult.none)) {
        await _syncService.addToQueue(ApiConstants.supir, 'POST', data);
        return;
      }
  ...
  Future<List<Pekerja>> getPekerjas() async {
    try {
      ...
      _syncService.cacheData('pekerja', data);
  ...
  Future<void> storePekerja(Map<String, dynamic> data) async {
    try {
      final connectivity = await Connectivity().checkConnectivity();
      if (connectivity.contains(ConnectivityResult.none)) {
        await _syncService.addToQueue(ApiConstants.pekerja, 'POST', data);
        return;
      }
  ...
  Future<List<Kendaraan>> getKendaraans() async {
    try {
      ...
      _syncService.cacheData('kendaraan', data);
  ...
  Future<void> storeKendaraan(Map<String, dynamic> data) async {
    try {
      final connectivity = await Connectivity().checkConnectivity();
      if (connectivity.contains(ConnectivityResult.none)) {
        await _syncService.addToQueue(ApiConstants.kendaraan, 'POST', data);
        return;
      }
  ...
  Future<void> storeOperasional(Map<String, dynamic> data) async {
    try {
      final connectivity = await Connectivity().checkConnectivity();
      if (connectivity.contains(ConnectivityResult.none)) {
        await _syncService.addToQueue(ApiConstants.operasional, 'POST', data);
        return;
      }
