      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              success
                  ? 'Logo unit bisnis berhasil diperbarui'
                  : 'Gagal memperbarui logo unit bisnis',
            ),
            backgroundColor: success ? Colors.green : const Color(0xFF0D47A1),
          ),
        );
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: _buildInfoTile(
                        (user?.perusahaanLogoUrl != null &&
                                user!.perusahaanLogoUrl!.isNotEmpty)
                            ? ClipRRect(
                    ...
                    _buildInfoTile(
                      const Icon(Icons.badge_rounded, color: Color(0xFF01579B)),
                      'Role',
                    ...
                    _buildInfoTile(
                      ...
                      'Kasir',
                      user?.perusahaanKasir ?? 'Kasir Utama',
                    ),
