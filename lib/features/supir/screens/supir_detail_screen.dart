...
class _SupirDetailScreenState extends State<SupirDetailScreen> {
  ...
  Future<void> _handleDelete() async {
    ...
    if (sisaHutang > 0) {
      ...
      if (confirmed == true && _currentSupir.isActive) {
        _handleToggleStatus();
      }
      return;
    }
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          _currentSupir.isActive ? 'AKTIF' : 'NONAKTIF',
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 10,
...
class _SupirEditBottomSheet extends StatefulWidget {
  final Supir supir;
...
class _SupirEditBottomSheetState extends State<_SupirEditBottomSheet> {
