      ...
      builder: (context, count, _) => Stack(
        ...
        children: [
          _CircleIconBtn(
            ...
            onTap: () {
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Memulai Sinkronisasi Data...')));
              SyncService().syncNow();
            },
          ),
